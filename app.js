 ...
 *                  territory fact, document-inventory placeholder, fix eyebrow accent,
...
const I18N = {
  es:{
    ...
    fp_docs_official_source:'Ver documentos en la fuente oficial',
    fp_doc_state_inventory:'Referencia oficial', fp_doc_state_resolved:'Enlace verificado',
    fp_doc_no_link:'Sin enlace directo',
    fp_docs_count_one:'1 documento', fp_docs_count:'{n} documentos',
    fp_docs_resolved_one:'1 con enlace verificado', fp_docs_resolved:'{m} con enlace verificado',
    doc_role_document:'Documento',
    doc_role_pcap:'Pliego administrativo (PCAP)', doc_role_ppt:'Pliego técnico (PPT)',
    doc_role_award_minutes:'Acta de adjudicación', doc_role_formalization_minutes:'Acta de formalización',
    doc_role_admin_spec:'Pliego administrativo',
    doc_role_notice_publication:'Anuncio de licitación', doc_role_notice_award:'Anuncio de adjudicación',
    doc_role_notice_resolution:'Anuncio de resolución', doc_role_notice_evaluation:'Anuncio de evaluación',
    doc_role_notice_preliminary:'Anuncio previo',
    doc_role_notice_contract_modification:'Anuncio de modificación de contrato',
    doc_role_tender_document:'Documento de licitación',
  ...
  ca:{
    ...
    fp_docs_official_source:'Veure documents a la font oficial',
    fp_doc_state_inventory:'Referència oficial', fp_doc_state_resolved:'Enllaç verificat',
    fp_doc_no_link:'Sense enllaç directe',
    fp_docs_count_one:'1 document', fp_docs_count:'{n} documents',
    fp_docs_resolved_one:'1 amb enllaç verificat', fp_docs_resolved:'{m} amb enllaç verificat',
    doc_role_document:'Document',
    doc_role_pcap:'Plec administratiu (PCAP)', doc_role_ppt:'Plec tècnic (PPT)',
    doc_role_award_minutes:"Acta d'adjudicació", doc_role_formalization_minutes:'Acta de formalització',
    doc_role_admin_spec:'Plec administratiu',
    doc_role_notice_publication:'Anunci de licitació', doc_role_notice_award:"Anunci d'adjudicació",
    doc_role_notice_resolution:'Anunci de resolució', doc_role_notice_evaluation:"Anunci d'avaluació",
    doc_role_notice_preliminary:'Anunci previ',
    doc_role_notice_contract_modification:'Anunci de modificació de contracte',
    doc_role_tender_document:'Document de licitació',
  ...
  eu:{
    ...
    fp_docs_official_source:'Ikusi dokumentuak iturri ofizialean',
    fp_doc_state_inventory:'Iturri ofizialeko erreferentzia', fp_doc_state_resolved:'Egiaztatutako esteka',
    fp_doc_no_link:'Esteka zuzenik gabe',
    fp_docs_count_one:'1 dokumentu', fp_docs_count:'{n} dokumentu',
    fp_docs_resolved_one:'1 egiaztatutako estekarekin', fp_docs_resolved:'{m} egiaztatutako estekarekin',
    doc_role_document:'Dokumentua',
    doc_role_pcap:'Baldintza administratiboen agiria (PCAP)', doc_role_ppt:'Baldintza teknikoen agiria (PPT)',
    doc_role_award_minutes:'Esleipen akta', doc_role_formalization_minutes:'Formalizazio akta',
    doc_role_admin_spec:'Baldintza administratiboen agiria',
    doc_role_notice_publication:'Lizitazio iragarkia', doc_role_notice_award:'Esleipen iragarkia',
    doc_role_notice_resolution:'Ebazpen iragarkia', doc_role_notice_evaluation:'Ebaluazio iragarkia',
    doc_role_notice_preliminary:'Aurretiazko iragarkia',
    doc_role_notice_contract_modification:'Kontratua aldatzeko iragarkia',
    doc_role_tender_document:'Lizitazio dokumentua',
  ...
  gl:{
    ...
    fp_docs_official_source:'Ver documentos na fonte oficial',
    fp_doc_state_inventory:'Referencia oficial', fp_doc_state_resolved:'Ligazón verificada',
    fp_doc_no_link:'Sen ligazón directa',
    fp_docs_count_one:'1 documento', fp_docs_count:'{n} documentos',
    fp_docs_resolved_one:'1 con ligazón verificada', fp_docs_resolved:'{m} con ligazón verificada',
    doc_role_document:'Documento',
    doc_role_pcap:'Prego administrativo (PCAP)', doc_role_ppt:'Prego técnico (PPT)',
    doc_role_award_minutes:'Acta de adxudicación', doc_role_formalization_minutes:'Acta de formalización',
    doc_role_admin_spec:'Prego administrativo',
    doc_role_notice_publication:'Anuncio de licitación', doc_role_notice_award:'Anuncio de adxudicación',
    doc_role_notice_resolution:'Anuncio de resolución', doc_role_notice_evaluation:'Anuncio de avaliación',
    doc_role_notice_preliminary:'Anuncio previo',
    doc_role_notice_contract_modification:'Anuncio de modificación de contrato',
    doc_role_tender_document:'Documento de licitación',
